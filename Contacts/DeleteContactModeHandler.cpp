...
void DeleteContactModeHandler::onAction(Action *action)
{
    ...
    case DisplayType::ContactList:
        ...
        case Enums::Button::Enter:
            mConfirmationDisplay.setRow(0, "Name: " + mContacts->at(mContactList->currentIndex())->name());
            mConfirmationDisplay.setRow(1, "Number: " + mContacts->at(mContactList->currentIndex())->phoneNumber());
